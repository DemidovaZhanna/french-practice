...
- Вввода данных в игровом разделе;
- Отображения статистики по терминологии.

Используемые функции:
- Обработка HTTP запросов и рендеринг шаблонов.
- Взаимодействие с модулями для работы с терминами, текстами и тестами (terms_work, texts_work, tests_work).
...
def show_stats(request):
    """
    Обрабатывает HTTP запрос и рендерит страницу со статистикой по терминам.
