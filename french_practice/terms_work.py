def get_terms_for_table(): # Парсинг terms.csv
...
def write_term(new_term, new_definition):   # Добавление термина в csv файл
...
def get_terms_stats():    # Расчет статистики по словам
    db_terms = 0
    user_terms = 0
    defin_len = []
